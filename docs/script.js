...
const priorityStoryBuilders = {
  "angry::understood": ({ name, backdrop }) =>
    createStory({
      title: `おこりんぼうの ${name}`,
      paragraphs: [
        `${name}は、夕方、つみきで 小さな おうちを 作っていました。`,
        `屋根を のせたら できあがり、というところで、おうちの人が「そろそろ かたづけようね」と 言いました。`,
        ...
        `ぴーは「わあ、ぷんぷんが 走ってる」と 小さく 言いました。`,
        `ごまじろうは、すぐに なおそうとせず、「どこから 来た ぷんぷんかな」と 聞きました。`,
        `${name}は「しらない。とにかく いや」と 言って、ほっぺを ふくらませました。`,
        `ぴーが「いきを ふーって したら、少しだけ 見えるかな」と 言いました。`,
        `${name}は、ふーっと いきを はきました。`,
        `けれど、ぷんぷんは まだ からだの中に のこっていました。`,
        `ごまじろうは「のこってるんだね」とだけ 言って、となりに すわりました。`,
        `その夜、ふとんの中で、おうちの人が「さっき、どうして あんなに おこったの？」と 聞きました。`,
        `${name}は しばらく だまってから、「あと ひとつで できたの。見てほしかったの」と 言いました。`,
        `それから、小さな こえで「すぐ やめてって 言われて、かなしくなった」と つけたしました。`,
        `おうちの人は「教えてくれて ありがとう。あと ひとつだったんだね」と 言いました。`,
        `${backdrop.texture}`,
